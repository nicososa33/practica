...
public class TipoDocumentoRequest extends RequestBase {
	...
	@NotBlank(message = ErrorCodes.CAMPO_OBLIGATORIO_FORMATO_USUARIO)
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TipoDocumentoRequest other = (TipoDocumentoRequest) obj;
		if (codigo == null) {
