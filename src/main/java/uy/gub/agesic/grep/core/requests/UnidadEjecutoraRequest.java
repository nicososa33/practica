...
public class UnidadEjecutoraRequest extends RequestBase {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UnidadEjecutoraRequest other = (UnidadEjecutoraRequest) obj;
		if (codigo == null) {
	...
	public String toString() {
		return "UnidadEjecutoraRequest [codigo=" + codigo + ", descripcion=" + descripcion + "]";
	}
