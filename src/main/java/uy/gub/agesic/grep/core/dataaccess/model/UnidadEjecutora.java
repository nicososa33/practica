...
@Entity
@Table(name = "adm_unidad_ejecutora", uniqueConstraints = @UniqueConstraint(columnNames = { "fecha_baja", "codigo" }))
@SQLDelete(sql = "UPDATE adm_unidad_ejecutora SET fecha_baja=NOW() WHERE id = ?")
...
public class UnidadEjecutora extends Auditable {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		UnidadEjecutora other = (UnidadEjecutora) obj;
		if (codigo == null) {
	...
	public String toString() {
		return "UnidadEjecutora [codigo=" + codigo + ", descripcion=" + descripcion + "]";
	}
